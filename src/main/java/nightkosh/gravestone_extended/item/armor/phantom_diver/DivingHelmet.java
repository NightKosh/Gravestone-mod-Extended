 ...
 */
public class DivingHelmet extends Item {

    private static final ResourceKey<Item> RK = ResourceKey.create(
            Registries.ITEM, fromNamespaceAndPath(ModInfo.ID, "diving_helmet"));
    ...
    public void appendHoverText(
        ...
        consumer.accept(Component.translatable("item.gravestone_extended.diving_helmet.tooltip"));
