...
public class CompatibilityAdvancedFishing {
    ...
    public static void addPotionsRecipes() {
        ...
        PotionHelper.addMix(PotionTypes.AWKWARD, Ingredient.fromStacks(new ItemStack(AdvancedFishingAPI.FISH_ITEM, 1,
                EnumFishType.GOLDEN_KOI.ordinal())), GSPotion.PURIFICATION_TYPE);
        PotionHelper.addMix(PotionTypes.AWKWARD, Ingredient.fromStacks(new ItemStack(AdvancedFishingAPI.FISH_ITEM, 1,
                EnumFishType.MAGMA_JELLYFISH.ordinal())), GSPotion.BURNING_TYPE);
        PotionHelper.addMix(PotionTypes.AWKWARD, Ingredient.fromStacks(new ItemStack(AdvancedFishingAPI.FISH_ITEM, 1,
                EnumFishType.PIRANHA.ordinal())), GSPotion.BLEEDING_TYPE);
        PotionHelper.addMix(GSPotion.BURNING_TYPE, Ingredient.fromStacks(new ItemStack(AdvancedFishingAPI.FISH_ITEM, 1,
                EnumFishType.FLAREFIN_KOI.ordinal())), GSPotion.INFERNO_TYPE);
        ...
        PotionHelper.addMix(PotionTypes.AWKWARD, Ingredient.fromStacks(new ItemStack(AdvancedFishingAPI.FISH_ITEM, 1,
                EnumFishType.BLUE_JELLYFISH.ordinal())), GSPotion.NAUSEA_TYPE);
        PotionHelper.addMix(PotionTypes.AWKWARD, Ingredient.fromStacks(new ItemStack(AdvancedFishingAPI.FISH_ITEM, 1,
                EnumFishType.CAVE_TROUT.ordinal())), GSPotion.RESISTANCE_TYPE);
        PotionHelper.addMix(PotionTypes.AWKWARD, Ingredient.fromStacks(new ItemStack(AdvancedFishingAPI.FISH_ITEM, 1,
                EnumFishType.CHORUS_KOI.ordinal())), GSPotion.LEVITATION_TYPE);
        PotionHelper.addMix(PotionTypes.AWKWARD, Ingredient.fromStacks(new ItemStack(AdvancedFishingAPI.FISH_ITEM, 1,
                EnumFishType.WITHERED_CRUCIAN.ordinal())), GSPotion.WITHER_TYPE);
    }
}
