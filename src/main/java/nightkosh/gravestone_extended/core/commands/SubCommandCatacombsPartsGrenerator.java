 ...
 */
public class SubCommandCatacombsPartsGrenerator {//TODO implements ISubCommand {
//
...
//                    generateComponent(sender.getEntityWorld(), CatacombsPortal.class, rand, x, y, z, facing, level);
//                    break;
//                default:
