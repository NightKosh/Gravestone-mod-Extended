 ...
 */
public class ResurrectionScreen extends AAltarScreen {

    private final MutableComponent resurrectionButtonStr = Component.translatable("gui.gravestone_extended.altar.resurrect");

    public ResurrectionScreen(AAltarContainerMenu menu, Inventory inventoryPlayer, Component title) {
    ...
    public void init() {
        super.init();
        guiResurrectionButton.active = false;
    }

    @Override
    protected void sendMessage() {
        GSEMessages.sendToServer(
                new ResurrectionMessageToServer(
    ...
    protected Identifier getGuiTexture() {
        return GSETextures.ALTAR_RESURRECTION_GUI;
    }
