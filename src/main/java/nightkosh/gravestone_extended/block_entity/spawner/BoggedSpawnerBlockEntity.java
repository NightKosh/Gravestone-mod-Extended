 ...
 */
public class BoggedSpawnerBlockEntity extends ASpawnerBlockEntity {

    private static final List<EntityType> MOBS = List.of(
            EntityType.BOGGED, EntityType.BOGGED, EntityType.BOGGED,
            EntityType.BOGGED, EntityType.BOGGED, EntityType.BOGGED,
            EntityType.BOGGED, EntityType.BOGGED, EntityType.BOGGED,
            EntityType.BOGGED, EntityType.BOGGED, EntityType.BOGGED,
            EntityType.BOGGED, EntityType.BOGGED, EntityType.BOGGED,
            ...
            BuiltInRegistries.ENTITY_TYPE.get(SKELETON_HORSE).get().value(),
            BuiltInRegistries.ENTITY_TYPE.get(BOGGED_CRAWLER).get().value());

    public BoggedSpawnerBlockEntity(BlockPos pos, BlockState blockState) {
        super(GSEBlockEntities.SPAWNER_BOGGED.get(), pos, blockState);
    }
